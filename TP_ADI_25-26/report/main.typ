...
- *Análise Avançada:* Na análise avançada fez-se uma comparação entre as diferentes combinações de inclusão/exclusão dos atributos relativos a precipitação e chuva, após isso 
